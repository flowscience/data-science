...
#NA's introduced by coercion were all "null" in the gse file
rownames(gse3) <- row.names(gse2)

targets <- read.delim("C:/Users/Eli/Desktop/otx_targets/gse6308_limma_sample_table_E8-EN.txt", stringsAsFactors=FALSE)
targs <- targets[,3:5]
design <- modelMatrix(targs, ref="FE")

fit <- lmFit(gse3, design)
contrast.matrix <- makeContrasts(levels=design, E16, E32, E64, EG, LG, EN, E16-E8, E32-E16, E64-E32, EG-E64, LG-EG, EN-LG)
contrast.matrix <- makeContrasts(levels=design, E16-E8, E32-E8, E64-E8, EG-E8, LG-E8, EN-E8, E32-E16, E64-E32, EG-E64, LG-EG, EN-LG)
...
write.table(fitd, "C:/users/eli/desktop/limma_gse6308_E8-EN_logFC.txt", quote=FALSE, sep='\t')
write.table(fit2d, "C:/users/eli/desktop/limma_gse6308_E8-EN_logFC_contrast.txt", quote=FALSE, sep='\t')
write.table(fitwd, "C:/users/eli/desktop/limma_gse6308_E8-EN_logFC_weighted.txt", quote=FALSE, sep='\t')
write.table(fitw2d, "C:/users/eli/desktop/limma_gse6308_E8-EN_logFC_weighted_contrast.txt", quote=FALSE, sep='\t')